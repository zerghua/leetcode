...
import java.util.*;
public class N649_Dota2Senate {
    // Valve
    // very smart idea to use two queues, greedy.
    ...
    public class Solution {
        public String predictPartyVictory(String senate) {
            ...
            while(!R.isEmpty() && !D.isEmpty()){
                int r_index = R.removeFirst(), d_index = D.removeFirst();
                if(r_index < d_index) R.add(r_index + n);   // also smart here

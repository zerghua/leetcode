 ...
 * Created by HuaZ on 8/27/2017.
 ...
 But could you find out the k-th largest number quickly from the multiplication table?

 Given the height m and the length n of a m * n Multiplication Table,
 and a positive integer k, you need to return the k-th largest number in this table.
 ...
 */
public class N668_KthlargestNumberinMultiplicationTable {
    // binary search
    // not sure why.
